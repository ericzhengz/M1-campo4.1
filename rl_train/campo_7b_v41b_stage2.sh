...
# =========================================================
# V4.1-B Stage 2: 32K max response length
# Based on campo_7b_v41b.sh (stage 1 = 16K)
# CAMPO C1 curriculum: progressive length increase
# =========================================================

project_name='miromind-m1'
exp_name='7b_v41b_stage2'
...
# Stage 2: same clip ratios as CAMPO stage2
clip_ratio_low=0.2
clip_ratio_high=0.28

max_prompt_length=1024
max_response_length=$((8192 * 4)) # 32k (stage 2)
...
# MODEL_PATH should point to the stage-1 checkpoint
