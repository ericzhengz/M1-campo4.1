...
# =========================================================
# V4.1-B Stage 3: 49K max response length
# Based on campo_7b_v41b.sh (stage 1 = 16K, stage 2 = 32K)
# CAMPO C1 curriculum: progressive length increase
# =========================================================

project_name='miromind-m1'
exp_name='7b_v41b_stage3'
...
# Stage 3: same clip ratios as CAMPO stage3
clip_ratio_low=0.2
clip_ratio_high=0.28

max_prompt_length=1024
max_response_length=$((1024 * 49)) # ~49k (stage 3)
...
# sigma_z_rho keeps credit-assignment coverage consistent across stages (P0-2)
v41b_sigma_z=5.0
...
# MODEL_PATH should point to the stage-2 checkpoint
MODEL_PATH=PATH_TO_STAGE2_CKPT
